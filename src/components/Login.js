    ...
    const signIn = (e) => {
        ...
        axios.post('https://shinto-backend.vercel.app/signin', {...state})
            .then(res => {
                ...
                document.cookie = cookie.serialize("shintoken", res.data.token, {maxAge: 10000})
                setUser(res.data.user)
                document.cookie = cookie.serialize("shintoUser", JSON.stringify(res.data.user), {maxAge: 10000})
